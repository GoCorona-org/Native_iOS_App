//
//  CalenderSeparator.swift
//  CovidTracker
//
//  Created by Tushar Chitnavis on 27/04/20.
...
class SeparatorCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for layoutAttributes in layoutAttributesArray {
            ...
            if let separatorAttributes = layoutAttributesForDecorationView(ofKind: "collectionSeparatorView", at: indexPath) {
    ...
    private func setup() {
        register(CollectionSeparatorView.self, forDecorationViewOfKind: "collectionSeparatorView")
    }
    
    
    private func createAttributesForMyDecoration(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes {
        return UICollectionViewLayoutAttributes(forDecorationViewOfKind: "collectionSeparatorView", with: indexPath)
    }
...
class CollectionSeparatorView: UICollectionReusableView {
    override init(frame: CGRect) {
        ...
        backgroundColor = UIColor(rgb: 0xD2D2D2)
    }
